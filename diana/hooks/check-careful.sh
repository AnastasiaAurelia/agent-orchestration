...
# Extract tool_input.command. Try grep/sed first (handles the common case),
# fall back to python3 for escaped quotes.
...
# --- Safe exception: rm -rf of well-known build/cache artifacts only ---
